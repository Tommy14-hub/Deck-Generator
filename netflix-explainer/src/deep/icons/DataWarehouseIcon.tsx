/**
 * Derived from @ultraviolet/icons DataWarehouseProductIcon (Scaleway, Apache-2.0).
 * Generated by scripts/extract-uv-icons.ts — do not edit by hand.
 */
import type { UvIconProps } from "./types";

export const DataWarehouseIcon: React.FC<UvIconProps> = ({ size = 64, style }) => (
  <svg
    fill="none"
    height={size}
    style={style}
    ...
    <g className="Datawarehouse" clipPath="url(#a)">
      ...
      <g className="Icon">
        <path
          ...
          clipRule="evenodd"
        />
        <g fill="var(--uv-strong)" className="fillStrong">
