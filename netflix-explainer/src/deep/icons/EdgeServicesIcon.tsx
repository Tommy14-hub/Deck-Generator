/**
 * Derived from @ultraviolet/icons EdgeServicesProductIcon (Scaleway, Apache-2.0).
 * Generated by scripts/extract-uv-icons.ts — do not edit by hand.
 */
import type { UvIconProps } from "./types";

export const EdgeServicesIcon: React.FC<UvIconProps> = ({ size = 64, style }) => (
  <svg
    fill="none"
    height={size}
    style={style}
  ...
  >
    <g className="edge-services" clipPath="url(#a)">
      <g className=".Square">
        <g fill="var(--uv-weak)" className="fillWeak">
      ...
      <g fill="var(--uv-base)" fillRule="evenodd" className="fill" clipRule="evenodd">
