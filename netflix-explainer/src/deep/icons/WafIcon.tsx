/**
 * Derived from @ultraviolet/icons WafProductIcon (Scaleway, Apache-2.0).
 * Generated by scripts/extract-uv-icons.ts — do not edit by hand.
 */
import type { UvIconProps } from "./types";

export const WafIcon: React.FC<UvIconProps> = ({ size = 64, style }) => (
  <svg
    fill="none"
    height={size}
    style={style}
  ...
  >
    <g className="sentiment=original, size=xlarge, disabled=false">
      <g className=".Square">
        <g fill="var(--uv-base)" className="fillWeak">
